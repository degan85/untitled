...
// myPath.insert(2, new Point(10, 80));
// myPath.insert(3, new Point(50, 70));
// myPath.closed = true;
//
...
// myPath1.strokeColor = 'black';
// myPath1.add(new Point(140, 190));
// myPath1.add(new Point(190, 140));
// myPath1.add(new Point(240, 190));
//
// myPath1.closed = true;
// myPath1.smooth();
...
//         text.content = -1 * Math.floor(vector.angle * 100) / 100 + '°';
